...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#F6F6F5]" style={{ color: "#222", fontFamily: "inherit" }}>
      ...
      <nav
        className="mx-auto"
        style={{ maxWidth: 1440, height: 90, paddingLeft: 40, paddingRight: 40, display: "grid", gridTemplateColumns: "1fr 1fr 1fr", alignItems: "center" }}
      >
      ...
      <div style={{ maxWidth: 1440, margin: "0 auto", paddingLeft: 40, paddingRight: 40 }}>
        ...
        <section id="contato" style={{ paddingBottom: 96 }}>
          ...
          <div className="flex items-center" style={{ marginTop: 20, gap: 16 }}>
            <span className="arrow-animate" style={{ display: "inline-flex" }}>
            ...
            <a
              ...
              className="hover:opacity-60 transition-opacity duration-200 text-[28px] md:text-[60px]"
              style={{
                fontWeight: 400,
